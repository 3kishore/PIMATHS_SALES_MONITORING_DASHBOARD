      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
        <div className="flex flex-col gap-2">
          ...
          <NewTestInputComponent
            ...
            {...register(ZONAL_HEAD.FORM_FIELDS.FIRST_NAME, {
              ...
              minLength: { value: 3, message: ZONAL_HEAD.FORM_ERROR_MSG.FIRST_NAME_3_CHART_MUST }
            })}
          />
        ...
        <div className="flex flex-col gap-2">
          ...
          <NewTestInputComponent
            ...
            {...register(ZONAL_HEAD.FORM_FIELDS.EMAIL_ID, {
              ...
              pattern: { value: REGEX.EMAIL_ID, message: ZONAL_HEAD.FORM_ERROR_MSG.INAVLID_EMAIL_ID }
            })}
          />
        ...
        <div className="flex flex-col gap-2">
          ...
          <NewTestInputComponent
            ...
            {...register(ZONAL_HEAD.FORM_FIELDS.MOBILE_NO, {
              ...
              pattern: { value: REGEX.MOBILE_NO, message: ZONAL_HEAD.FORM_ERROR_MSG.INAVLID_MOBILE_NO }
            })}
          />
        ...
        <div className="flex flex-col gap-2">
          ...
          <NewSelectComponent
            ...
            {...register(ZONAL_HEAD.FORM_FIELDS.DEPARTMENT)}
          />
        </div>
        <div className="flex flex-col gap-2">
